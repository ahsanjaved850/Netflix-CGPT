    ...
    return (
        <div>
          ...
          <div className="p-4 w-1/2 md:h-4/12 mx-auto bg-gradient-to-r from-black text-white absolute md:pl-10 md:p-4 top[150px] max-[1300px]:top-[150px] md:top-[280px]">
            <p className="font-semibold text-md md:font-bold md:text-2xl">{title}</p>
            <p className="max-[1100px]:hidden inline-block text-justify text-lg w-full py-4">{overview}</p>
            <button className="max-[1100px]:hidden inline-block cursor-pointer bg-gray-200 text-black font-bold px-5 py-1 rounded-md hover:bg-opacity-80">Play</button>
            <button className="max-[1100px]:hidden inline-block cursor-pointer ml-1 bg-gray-500 text-white px-5 py-1 rounded-md hover:bg-opacity-80">More info</button>
          </div>
        </div>
      );
};
